...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"javascript/portofolio.js":[function(require,module,exports) {
...
function secondvalid() {
  ...
  var phone_check = /^\+2507[2389]\d{6}$/;
  var email_checker = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
...
form.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var name, email, message, datas, response, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 5;
          _context.next = 8;
          return fetch('https://my-brand-manzi-backend.onrender.com/api/messages', {
            method: 'POST',
            headers: {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","javascript/portofolio.js"], null)
//# sourceMappingURL=/portofolio.5931cd63.js.map